...
namespace :setup do
  ...
  task :default_group => [:environment] do
    default_tags = ["Search Engine", "Heroku", "Social API Integration", "Query Optimization", "Amazon API Integration", "Js Libraries", "Payment GateWay API Integration", "CMS", "latest Tips"]
  ...
  task :create_admin => [:environment] do
    admin = User.new
    {
      ...
      :email => "knowledegebase@railsfactory.org",
      :role => "admin"
