class Question
  ...
  include Railsknowledgebase::Models::GeoCommon
  include Railsknowledgebase::Models::Trackable

  paginates_per 10

  track_activities :user, :title, :body, :language, :scope => [:group_id] do |activity, question|
...
#   referenced_in :last_target, :polymorphic => true
  ...
  validates_length_of :body,     :minimum => 20, :allow_blank => false #, :if => lambda { |q| !q.disable_limits? }
