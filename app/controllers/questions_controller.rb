class QuestionsController < ApplicationController
  ...
  def create
    ...
    @question.user = User.last#current_user
    ...
    respond_to do |format|
      if (@question.user ||  (@question.user.valid? && recaptcha_valid?)) && @question.save
  ...
  def update
    @question=Question.find(params[:id])
    @question.update_attributes(:title=>params[:question][:title], :body=>params[:question][:body], :tags=>params[:question][:tags])
